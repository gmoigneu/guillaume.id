...
import logoAskCodex from '@/images/logos/askcodex.png'
import logoFeverLog from '@/images/logos/feverlog.webp'
import logoFilmReciprocity from '@/images/logos/reciprocity.webp'
...
const projects = [
  ...
  },
  {
    name: 'FeverLog',
    description:
      'FeverLog is an iOS app for tracking fever and other symptoms for kids.',
    link: { href: 'https://feverlog.net/', label: 'feverlog.net' },
    logo: logoFeverLog,
  },
  {
    name: 'Film reciprocity (open source)',
    description:
      'iOS app for photographers to calculate the correct exposure time for their film.',
    link: { href: 'https://filmreciprocity.com/', label: 'filmreciprocity.com' },
    logo: logoFilmReciprocity,
  }
]
